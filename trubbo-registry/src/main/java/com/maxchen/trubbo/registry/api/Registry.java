...
public interface Registry {
    ...
    void watchServiceConfiguration(String serviceName, ZookeeperListener listener);

    void watchMethodConfiguration(String serviceName, ZookeeperListener listener);
}
